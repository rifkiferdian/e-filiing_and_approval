  ...
  <div class="content-wrapper">
      ...
      <section class="content-header">
          <div class="container-fluid">
              <div class="row mb-2">
                  <div class="col-sm-6">
                      <h1>Klasifikasi Unit Kerja</h1>
                  </div>
                  <div class="col-sm-6">
                      <ol class="breadcrumb float-sm-right">
                          <li class="breadcrumb-item"><a href="#">Home</a></li>
                          <li class="breadcrumb-item active">Klasifikasi Unit Kerja</li>
                      </ol>
                  </div>
              </div>
          </div><!-- /.container-fluid -->
                                  ...
                                  <div class="row">
                                      <div class="col-md-6">
                                          <div class="form-group">
                                              <label for="nama">Kode Unit Kerja</label>
                                              <input type="text" class="form-control" id="kode" name="kode" placeholder="Kode Unit">
                                          </div>
                                          <div class="form-group">
                                              <label for="alamat">Nama Unit Kerja</label>
  ...
  <script>
      ...
      $(function() {
          $("#example1").DataTable({
              ...
              'ajax': {
                  'dataType': 'json',
                  'url': '<?= base_url() ?>dashboard/ajax_table_unit',
                  'type': 'post',
              },
              'columns': [{
                  "target": [<?= $target ?>],
      ...
      $("#form-input").submit(function(e) {
          ...
          var url_ajax = '<?= base_url() ?>dashboard/addunit'
              ...
              success: function(result) {
                  if (result.status == 200) {
                      Swal.fire({
                          icon: 'success',
                          title: 'Berhasil!',
                          text: 'Unit kerja baru berhasil didaftarkan!',
                      })
                      reload_table()
                      $('#tambah-user').hide();
                      $('#list-user').show(500);
